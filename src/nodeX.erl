...
forward_probe(Ref, T,Size, Nodes, Id, Successor,Store) -> 
	...
	Nodes2 = lists:append(Nodes, [Id]),
	Size1 =Size + length(Store),
	Spid ! {probe,Ref,Size1,Nodes2,T}.
